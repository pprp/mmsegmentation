...
class BasicBlock(BaseModule):
    ...
    def __init__(self,
        ...
        if att == None:
            ...
            self.attention = SE(planes, reduction=16)
        elif att == "CBAM":
            self.attention = CBAM(planes, reduction_ratio=16)
        elif att == "RF":
            self.attention = ReceptiveFieldAttention(
            planes, genotype=Genotype(normal=[('strippool', 0), ('avg_pool_3x3', 0), ('avg_pool_5x5', 1), ('avg_pool_7x7', 0), ('strippool', 2), ('noise', 1)], normal_concat=range(0, 4))
...
class ResNet_Att(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None, 
                 att=None):
        super(ResNet_Att, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNet_Att, self).train(mode)
        self._freeze_stages()
...
@BACKBONES.register_module()
class ResNetV1c_Att(ResNet_Att):
...
@BACKBONES.register_module()
class ResNetV1d_Att(ResNet_Att):
